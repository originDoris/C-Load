...
public class VertxGeneratorBuilder {
    ...
    static class APIStepImpl implements APIStep {
        ...
        public ExecutionStep withRX3API() {
            return new ExecutionStepImpl(base
                    ...
                    .setRenderDAOInterfaceDelegate((rType, pType, tType) -> String.format("com.cl.framework.plugin.jooq.rx3.VertxDAO<%s,%s,%s>", rType, pType, tType))
            );
        }
    ...
    static class ExecutionStepImpl implements ExecutionStep {
        ...
        public DIStep withPostgresReactiveDriver() {
            base.setRenderDAOExtendsDelegate(()->"com.cl.framework.plugin.jooq.shared.reactive.AbstractReactiveVertxDAO");
            ...
            switch(base.apiType){
                case RX3:
                  return new DIStepImpl(base
                          .setWriteDAOImportsDelegate(base.writeDAOImportsDelegate.andThen(out -> out.println("import com.cl.framework.plugin.jooq.rx3.ReactiveRXQueryExecutor;")))
        ...
        public FinalStep withGuice(boolean generateGuiceModules, NamedInjectionStrategy namedInjectionStrategy) {
            ...
            if (generateGuiceModules) {
                base.addWriteExtraDataDelegate((schema, writerGen) -> {
                    ...
                    switch (base.apiType) {
                        case RX3:
                            daoClassName = "com.cl.framework.plugin.jooq.rx3.VertxDAO";
                            break;
                        default:
